...
<div style="width: 250px; height: 100vh; background-color: #0f172a; color: #ffffff; 
display: flex; flex-direction: column; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; 
position: fixed; left: 0; top: 0; box-shadow: 2px 0 8px rgba(0,0,0,0.15); z-index: 1000;">
...
<nav style="flex: 1; padding: 24px 0; overflow-y: auto;">
        ...
        <li style="padding: 0 24px 10px 24px; font-size: 11px; text-transform: uppercase; color: #475569;
         font-weight: bold; letter-spacing: 1px;">Links</li>
          <li style="margin-bottom: 4px; padding: 0 12px;">
                <a href="userDashboard.jsp" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px;
                 color: #ffffff; background-color: #1e293b; text-decoration: none; border-radius: 8px; 
                 font-weight: 600; border-left: 4px solid #38bdf8;">
                    <i class="fa-solid fa-gauge" style="width: 20px; font-size: 16px; color: #38bdf8;"></i> Dashboard
                </a>
         </li>

         <li style="margin-bottom: 4px; padding: 0 12px;">
                <a href="myBookings.jsp" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px;
                 color: #94a3b8; text-decoration: none; border-radius: 8px; transition: all 0.2s ease;
           ...
           <li style="margin-bottom: 4px; padding: 0 12px;">
                <a href="changePassword.jsp" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px;
                 color: #94a3b8; text-decoration: none; border-radius: 8px; transition: all 0.2s ease;
                 " onmouseover="this.style.backgroundColor='#1e293b'; this.style.color='#ffffff';"
                  onmouseout="this.style.backgroundColor='transparent'; this.style.color='#94a3b8';">
     ...
     <div style="padding: 16px; border-top: 1px solid #1e293b;">
        <a href="logout" style="display: flex; align-items: center; justify-content: center; gap: 8px;
         background-color: #ef4444; color: #ffffff; padding: 12px; border-radius: 8px; text-decoration: none; 
