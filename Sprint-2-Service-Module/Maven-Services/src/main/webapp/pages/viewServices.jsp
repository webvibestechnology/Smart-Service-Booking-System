...
<head>
    ...
    <style>
        .navbar { background-color: #0c1427; color: white; padding: 12px 25px; }
        .logo-box { background-color: #3b82f6; padding: 8px 12px; border-radius: 8px; }
        ...
        .btn-book { background-color: #3b82f6; color: white; border-radius: 6px; width: 100%; }
